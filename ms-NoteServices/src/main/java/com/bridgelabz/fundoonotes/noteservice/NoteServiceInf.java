...
public interface NoteServiceInf {
	...
	Note updateNote(int noteId, String token, Note note, HttpServletRequest request);
	...
	//	
	//	Labels createLabel(String token, Labels label, HttpServletRequest request);
	//	
	//	Labels updateLabel(int id,String token, Labels label, HttpServletRequest request);
	//	
	//	boolean  deleteLabel(int id,String token, HttpServletRequest request);
	//	
	//	List<Labels> retrieveLabel(String token, HttpServletRequest request);
	//		
